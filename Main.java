...
class Main
{
    public static void main(String[] args)
    {
        ...
        out.println("Task №1. Сумма знаков.");
        out.println("Task №2. Есть ли позитив.");
        out.println("Task №3. Большая буква.");
        out.println("Task №4. Делитель.");
        out.println("Task №5. Многократный вызов.");
        out.println("Task №6. Безопасное деление.");
        out.println("Task №7. Строка сравнения.");
        out.println("Task №8. Тройная сумма.");
        out.println("Task №9. Возраст.");
        out.println("Task №10. Вывод дней недели.");
        out.println("Task №11. Числа наоборот.");
        out.println("Task №12. Степень числа.");
        out.println("Task №13. Одинаковость.");
        out.println("Task №14. Левый треугольник.");
        out.println("Task №15. Угадайка");
        out.println("Task №16. Поиск последнего значения.");
        out.println("Task №17. Добавление в массив.");
        out.println("Task №18. Реверс.");
        out.println("Task №19. Объединение.");
        out.println("Task №20. Удалить негатив.");
        int num = in.nextInt();
        int x, y, z, a, b, pos;
        int[] Arr, Arr1, Arr2;
        String str;
